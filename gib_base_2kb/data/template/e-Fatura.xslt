        ...
        <html>
            ...
            <body style="margin-left=0.6in; margin-right=0.6in; margin-top=0.79in; margin-bottom=0.79in">
                ...
                <table class="invoice-line border w-800">
                    <thead>
                        <tr>
                            ...
                            <xsl:if test="//n1:Invoice/cac:InvoiceLine/cac:Delivery/cac:Shipment/cbc:DeclaredCustomsValueAmount">
                ...
                <div class="w-800 mt-10">
                    ...
                    <xsl:if test="//n1:Invoice/cac:Delivery/cac:DeliveryAddress/cbc:StreetName and //n1:Invoice/cbc:ProfileID='IHRACAT'">
                        <div class="sevk-adresi f-l" style="width:450px">
                            <b>Malın Teslim ve Bedelinin Ödeme Yeri</b>
                            <br/>
                            ...
                            <br/>
                            <xsl:value-of select="//n1:Invoice/cac:Delivery/cac:DeliveryAddress/cac:Country/cbc:Name"/>
                        </div>
                    </xsl:if>                    
