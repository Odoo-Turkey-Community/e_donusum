...
<xsl:stylesheet version="2.0"
                ...
                xmlns:exslt="http://exslt.org/common" exclude-result-prefixes="cac cbc ccts clm54217 clm5639 clm66411 clmIANAMIMEMediaType fn link n1 qdt udt xbrldi xbrli xdt xlink xs xsd xsi lcl svg my exslt">
        ...
        <html>
            <head>
                ...
                <style type="text/css">
                    ...
                    #masraflar > thead > tr:last-child > th {
                    text-align:right
                    }
                    #masraflar > tbody > tr > td {
                    text-align:right
                    }
                    #okc > tbody > tr > td {
                    text-align:center
                    ...
                    td.allowance > div:not(:last-child) {
                    padding-bottom:3px;
                    border-bottom:1px solid #ccc
                    }
                    #internet-satis {
                    ...
                    #internet-satis > tbody > tr > th {
                    text-align:left
                    }
                    #internet-satis > tbody > tr > td,
                    #internet-satis > tbody > tr > th {
                    padding:3px 5px
                    }
                    #bankaHesap {
            ...
            <body style="margin-left=0.6in; margin-right=0.6in; margin-top=0.79in; margin-bottom=0.79in">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="20%" align="center" valign="middle">
                                ...
                                <img id="company_sign" style="width:100%" src=""/>
                                <!-- StampContent -->
                            </td>
                                    ...
                                    <table class="key-value-table">
                                        <tbody>
                                            ...
                                            <xsl:for-each select="n1:Invoice/cac:TaxRepresentativeParty/cac:PartyIdentification/cbc:ID[@schemeID='ARACIKURUMVKN']">
                                                <tr>
                                                    <td>Aracı Kurum VKN</td>
                                                    <td>
                                                        <xsl:value-of select="." />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Aracı Kurum Unvan</td>
                                                    <td>
                                                        <xsl:value-of select="../../cac:PartyName/cbc:Name" />
                                                    </td>
                                                </tr>
                    ...
                    <thead>
                        <tr>
                            ...
                            <xsl:if test="//n1:Invoice/cac:InvoiceLine/cac:Item/cbc:Description">
                                <th class="t-l">Açıklama</th>
                            </xsl:if>
                            <xsl:if test="//n1:Invoice/cac:InvoiceLine/cac:Item/cac:BuyersItemIdentification/cbc:ID">
                                <th class="t-l">Alıcı Ürün Kodu</th>
                            </xsl:if>
                            <xsl:if test="//n1:Invoice/cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cbc:ID">
                                <th class="t-l">Mal/Hizmet Kodu</th>
                            </xsl:if>
                            <th class="t-r">Miktar</th>
                            <th class="t-r">Birim Fiyat</th>
                            <xsl:if test="//n1:Invoice/cac:InvoiceLine/cac:AllowanceCharge[cbc:Amount!=0 or cbc:MultiplierFactorNumeric!=0]/cbc:ChargeIndicator='false'">
                            ...
                            <xsl:if test="//n1:Invoice/cac:InvoiceLine/cac:AllowanceCharge[cbc:Amount!=0 or cbc:MultiplierFactorNumeric!=0]/cbc:ChargeIndicator='true'">
                                <th style="min-width:90px">
                                    Artırım Oran
                                    <br />
                                    Tutar
                            ...
                            <xsl:if test="//n1:Invoice/cbc:InvoiceTypeCode != 'OZELMATRAH' and //n1:Invoice/cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReasonCode">
                                <th class="t-l">KDV İstisna Nedeni</th>
                            </xsl:if>
                            <th class="t-r">
                                <xsl:choose>
                                    <xsl:when test="//n1:Invoice/cbc:InvoiceTypeCode='TEVKIFATIADE'">
                            ...
                            <xsl:if test="(//n1:Invoice/cbc:ProfileID='HKS') or (//n1:Invoice/cbc:ProfileID='EARSIVFATURA' and (//n1:Invoice/cbc:InvoiceTypeCode='HKSSATIS' or //n1:Invoice/cbc:InvoiceTypeCode='HKSKOMISYONCU'))">
                                <th class="t-l">Künye Numarası</th>
                            </xsl:if>
                            <xsl:if test="(//n1:Invoice/cbc:ProfileID='HKS' and //n1:Invoice/cbc:InvoiceTypeCode='SATIS') or (//n1:Invoice/cbc:ProfileID='EARSIVFATURA' and //n1:Invoice/cbc:InvoiceTypeCode='HKSSATIS')">
                                <th class="t-l">Mal Sahibi VKN/TCKN</th>
                                <th class="t-l">Mal Sahibi Ad/Soyad</th>
                            </xsl:if>
                            <xsl:if test="//n1:Invoice/cbc:InvoiceTypeCode='OZELMATRAH'">
                                <th class="t-l">Özel Matrah Nedeni</th>
                                <th class="t-r">Özel Matrah Tutarı</th>
                            </xsl:if>
                            <xsl:if test="//n1:Invoice/cbc:ProfileID='EARSIVFATURA' and //n1:Invoice/cbc:InvoiceTypeCode='ISTISNA'">
                                <th class="t-l">GTİP</th>
                            </xsl:if>
                            <xsl:if test="//n1:Invoice/cbc:InvoiceTypeCode='TEVKIFATIADE'">
                                <th class="t-r">Tevkifatsız KDV Tutarı</th>
                            </xsl:if>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <div class="w-800 mt-10">
                    <xsl:if test="//n1:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode[text()='İADE' or text()='IADE']">
                        <table class="table f-l border" style="width:450px" id="iade">
                            <thead>
                                <tr>
                                    <th colspan="2">İadeye Konu Olan Faturalar</th>
                                </tr>
                                <tr>
                                    <th>Fatura No</th>
                                    <th>Tarih</th>
                    ...
                    <xsl:if test="(//n1:Invoice/cbc:ProfileID='HKS' and //n1:Invoice/cbc:InvoiceTypeCode='KOMISYONCU') or (//n1:Invoice/cbc:ProfileID='EARSIVFATURA' and //n1:Invoice/cbc:InvoiceTypeCode='HKSKOMISYONCU')">
                        <table id="masraflar" class="table border f-l" style="width:450px;">
                            <thead>
                                <tr>
                                    <th colspan="3">Masraflar</th>
                                </tr>
                                <tr>
                                    <th>Masraf Türü</th>
                                    <th>Tutar</th>
                            ...
                            <tbody>
                                <xsl:for-each select="n1:Invoice/cac:AllowanceCharge">
                                    <xsl:if test="starts-with(cbc:AllowanceChargeReason,'HKS')">
                                        <tr>
                                            <td>
                                                <xsl:call-template name="HKS_Text" />
                                            </td>
                                            <td>
                    ...
                    <table id="monetory-total" class="key-value-table">
                        <tbody>
                            <tr>
                                <td>
                                    <xsl:choose>
                            ...
                            <tr>
                                <xsl:variable name="toplamSatirIndirim" select="sum(//n1:Invoice/cac:InvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator='false']/cbc:Amount)" />
                                <xsl:variable name="toplamSatirArtirim" select="sum(//n1:Invoice/cac:InvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator='true']/cbc:Amount)" />
                                <xsl:choose>
                                    <xsl:when test="$toplamSatirArtirim > $toplamSatirIndirim">
                                        <td>
                ...
                <xsl:if test="//n1:Invoice/cac:BillingReference/cac:AdditionalDocumentReference/cbc:DocumentTypeCode='OKCBF'">
                    <table class="table border w-800 mt-10" id="okc">
                        <thead>
                            <tr>
                ...
                <div class="hr w-800 mt-10" style="clear:both" />
                <table class="f-l w-800">
                    <tbody>
                        <tr>
                            <td style="padding:10px 0px">
                                ...
                                <b>
                                    YALNIZ:&#160;
                                    <xsl:call-template name="humanizeCurrency">
                ...
                <div class="hr w-800 mb-10" style="clear:both" />
                <!-- BankInformation -->
                <!--%XSLT_DOWNLOAD_IBANS_TABLE%-->
				<xsl:if test="//n1:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount != ''">
					<table id="bankaHesap" width="800px" style="margin-top:10px">
                        <thead>
                            <tr>
                                <th>Banka Adı</th>
                                <th>Şube</th>
                ...
                <xsl:if test="//n1:Invoice/cbc:ProfileID='EARSIVFATURA'">
                    ...
                    <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'SEND_TYPE']">
                        <xsl:if test="cbc:ID='ELEKTRONIK'">
                            <div class="mt-10"> e-Arşiv izni kapsamında elektronik ortamda iletilmiştir. </div>
                        </xsl:if>
                    </xsl:for-each>
                    <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'IS_INTERNET']">
                        <div id="internetSatis" style="margin-top:5px">
                            ...
                            <table class="w-800 mt-5" id="internet-satis">
                                <tbody>
                                    <tr>
                                        <th>Web Adresi</th>
                                        <td>
                            ...
                            <table class="table border w-800 mt-10 mb-5">
                                <thead>
                                    <tr>
                                        <th colspan="5" style="font-weight:bold">İade Edilen Mal Bilgileri</th>
                                    </tr>
                                    <tr>
                                        <th style="width:450px;">Mal Hizmet</th>
                                        <th style="width:100px;">Adet</th>
                                        <th style="width:100px;">Birim Fiyatı</th>
                                        <th style="width:100px;">Tutarı</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <xsl:for-each select="//n1:Invoice/cac:InvoiceLine">
                    ...
                    <div class="mt-10">
                        <div style="width:auto; margin-bottom:10px; margin-top:3px">
                            Bu fatura Odoo 2KB Türkiye yerelleştirmesi üzerinden oluşturulmuştur.
                            <a target="_blank" style="font-weight:bold" href="https://2kb.com.tr">
                                2kb.com.tr
                            </a>
    ...
    <xsl:template match="//n1:Invoice/cac:InvoiceLine">
        <tr>
            ...
            <xsl:if test="//n1:Invoice/cac:InvoiceLine/cac:AllowanceCharge[cbc:Amount!=0 or cbc:MultiplierFactorNumeric!=0]/cbc:ChargeIndicator='false'">
                <td class="t-r allowance">
                    <xsl:for-each select="./cac:AllowanceCharge[cbc:Amount!=0 or cbc:MultiplierFactorNumeric!=0][cbc:ChargeIndicator='false']/cbc:Amount">
                        <div>
                            <div>
                                %
                            ...
                            <xsl:if test="../cbc:AllowanceChargeReason">
                                <div class="t-l wrap">
                                    <b style="white-space:nowrap">Sebep: </b>
                                    <i>
            ...
            <xsl:if test="//n1:Invoice/cac:InvoiceLine/cac:AllowanceCharge[cbc:Amount!=0 or cbc:MultiplierFactorNumeric!=0]/cbc:ChargeIndicator='true'">
                <td class="t-r allowance">
                    <xsl:for-each select="./cac:AllowanceCharge[cbc:Amount!=0 or cbc:MultiplierFactorNumeric!=0][cbc:ChargeIndicator='true']/cbc:Amount">
                        <div>
                            <div>
                                %
                                <xsl:value-of select="format-number(../cbc:MultiplierFactorNumeric * 100, '###.##0,00', 'european')" />
            ...
            <xsl:if test="//n1:Invoice/cbc:ProfileID='STDKODFATURA'">
                ...
                <td>
                    <xsl:value-of select="format-number(./cac:SubInvoiceLine/cbc:InvoicedQuantity, '###.###,####', 'european')" />
        ...
        <xsl:if test="//n1:Invoice/cbc:ProfileID='IHRACAT' or //n1:Invoice/cbc:ProfileID='OZELFATURA'">
            ...
            <tr>
                <td colspan="30" style="padding:10px !important;">
                    <table class="table border ihracat" style="width:780px">
                        <thead>
                            <tr>
                                <xsl:if test="cac:Delivery/cac:DeliveryTerms/cbc:ID[@schemeID='INCOTERMS']">
                                    <th>Teslim Şartı</th>
                                </xsl:if>
                                <xsl:if test="cac:Delivery/cac:Shipment/cac:TransportHandlingUnit/cac:ActualPackage/cbc:PackagingTypeCode">
                                    <th class="wrap">Eşya Kap Cinsi</th>
                                </xsl:if>
                                ...
                                <xsl:if test="cac:Delivery/cac:DeliveryAddress">
                                    <th class="wrap">Teslim/Bedel Ödeme Yeri</th>
                                </xsl:if>
                                <xsl:if test="cac:Delivery/cac:Shipment/cac:ShipmentStage/cbc:TransportModeCode">
                                    <th>Gönderilme Şekli</th>
                                </xsl:if>
                                <xsl:if test="cac:Delivery/cac:Shipment/cac:GoodsItem/cbc:RequiredCustomsID">
                                    <th>GTİP</th>
                                </xsl:if>
                                <xsl:if test="cac:Delivery/cac:Shipment/cbc:DeclaredCustomsValueAmount">
                                    <th>Byn. Edilen Kıymet Değeri</th>
                                </xsl:if>
                            </tr>
                        </thead>
                        <tbody>
    ...
    <xsl:template name="UnitText">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$UnitCode='DR'">Bidon</xsl:when>
            ...
            <xsl:when test="$UnitCode='DMK'">dm2</xsl:when>
            ...
            <xsl:when test="$UnitCode='MWH'">MWH</xsl:when>
            ...
            <xsl:when test="$UnitCode='Q37'">SCM</xsl:when>
            <xsl:when test="$UnitCode='Q39'">NCM</xsl:when>
            <xsl:when test="$UnitCode='J39'">mmBTU</xsl:when>
            <xsl:when test="$UnitCode='G52'">CM3</xsl:when>
            <xsl:when test="$UnitCode='DZN'">Düzine</xsl:when>
        </xsl:choose>
    </xsl:template>
    ...
    <xsl:template name="HKS_Text">
        <xsl:choose>
            <xsl:when test="cbc:AllowanceChargeReason='HKSKOMISYON'">Komisyon</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSKOMISYONKDV'">Komisyon KDV</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSNAVLUN'">Navlun</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSNAVLUNKDV'">Navlun KDV</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSHAMMALIYE'">Hammaliye</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSHAMMALIYEKDV'">Hammaliye KDV</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSNAKLIYE'">Nakliye</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSNAKLIYEKDV'">Nakliye KDV</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSGVTEVKIFAT'">G.V. Tevkifat</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSBAGKURTEVKIFAT'">Bağkur Tevkifat</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSRUSUM'">Rüsum</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSRUSUMKDV'">Rüsum KDV</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSTICBORSASI'">Ticaret Borsası</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSTICBORSASIKDV'">Ticaret Borsası KDV</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSMILLISAVUNMAFON'">Milli Savunma Fon</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSMSFONKDV'">Milli Savunma Fon KDV</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSDIGERMASRAFLAR'">Diğer Masraflar</xsl:when>
            <xsl:when test="cbc:AllowanceChargeReason='HKSDIGERKDV'">Diğer KDV</xsl:when>
        </xsl:choose>
    </xsl:template>
    <xsl:template name="humanizeCurrency">
    <xsl:param name="code" />
    <xsl:variable name="number" select="." />
    <xsl:variable name="fraction" select="round(($number - floor($number)) * 100)" />
    <xsl:call-template name="humanizeNumber">
        <xsl:with-param name="number" select="." />
    </xsl:call-template>
    <xsl:if test="$code">
        <xsl:choose>
            <xsl:when test="$code = 'TRL' or $code = 'TRY'">
                <xsl:text>TL</xsl:text>
                <xsl:if test="$fraction > 0">
                    <xsl:text>&#160;</xsl:text>
                    <xsl:call-template name="humanizeNumber">
                        <xsl:with-param name="number" select="$fraction" />
                    </xsl:call-template>
...
<xsl:template name="humanizeNumber">
    <xsl:param name="number" />
    <xsl:variable name="tam_sayi" select="floor($number)" />
    <xsl:variable name="units" select="floor($number) mod 10" />
    <xsl:variable name="tens" select="floor(floor($tam_sayi mod 100) div 10)" />
    <xsl:variable name="hundreds" select="floor(floor($tam_sayi mod 1000) div 100)" />
    <xsl:variable name="thousands" select="floor(floor($tam_sayi mod 1000000) div 1000)" />
    <xsl:variable name="millions" select="floor(floor($tam_sayi mod 1000000000) div 1000000)" />
    <xsl:variable name="billions" select="floor(floor($tam_sayi mod 1000000000000) div 1000000000)" />
    <xsl:if test="$billions > 0">
        <xsl:call-template name="parseNumberGroup">
            <xsl:with-param name="number" select="$billions" />
        </xsl:call-template>
        <xsl:text>MİLYAR&#160;</xsl:text>
    </xsl:if>
    <xsl:if test="$millions > 0">
        <xsl:call-template name="parseNumberGroup">
            <xsl:with-param name="number" select="$millions" />
        </xsl:call-template>
        <xsl:text>MİLYON&#160;</xsl:text>
    </xsl:if>
    <xsl:if test="$thousands > 0">
        <xsl:if test="$thousands = 1">
            <xsl:text>BİN&#160;</xsl:text>
        </xsl:if>
        <xsl:if test="$thousands > 1">
            <xsl:call-template name="parseNumberGroup">
                <xsl:with-param name="number" select="$thousands" />
            </xsl:call-template>
            <xsl:text>BİN&#160;</xsl:text>
        </xsl:if>
    </xsl:if>
    <xsl:call-template name="hundredsDigit">
        <xsl:with-param name="digit" select="$hundreds" />
    </xsl:call-template>
    <xsl:call-template name="tensDigit">
        <xsl:with-param name="digit" select="$tens" />
    </xsl:call-template>
    <xsl:call-template name="unitsDigit">
        <xsl:with-param name="digit" select="$units" />
    </xsl:call-template>
</xsl:template>
<xsl:template name="parseNumberGroup">
    <xsl:param name="number" />
    <xsl:variable name="tam_sayi" select="floor($number)" />
    <xsl:variable name="units" select="floor($number) mod 10" />
    <xsl:variable name="tens" select="floor(floor($tam_sayi mod 100) div 10)" />
...
<xsl:template name="unitsDigit">
    <xsl:param name="digit" />
    <xsl:choose>
        <xsl:when test="$digit=1">BİR&#160;</xsl:when>
        <xsl:when test="$digit=2">İKİ&#160;</xsl:when>
        <xsl:when test="$digit=3">ÜÇ&#160;</xsl:when>
        <xsl:when test="$digit=4">DÖRT&#160;</xsl:when>
        <xsl:when test="$digit=5">BEŞ&#160;</xsl:when>
        <xsl:when test="$digit=6">ALTI&#160;</xsl:when>
        <xsl:when test="$digit=7">YEDİ&#160;</xsl:when>
        <xsl:when test="$digit=8">SEKİZ&#160;</xsl:when>
        <xsl:when test="$digit=9">DOKUZ&#160;</xsl:when>
        <xsl:otherwise />
    </xsl:choose>
</xsl:template>
<xsl:template name="tensDigit">
    <xsl:param name="digit" />
    <xsl:choose>
        <xsl:when test="$digit=1">ON&#160;</xsl:when>
        <xsl:when test="$digit=2">YİRMİ&#160;</xsl:when>
        <xsl:when test="$digit=3">OTUZ&#160;</xsl:when>
        <xsl:when test="$digit=4">KIRK&#160;</xsl:when>
        <xsl:when test="$digit=5">ELLİ&#160;</xsl:when>
        <xsl:when test="$digit=6">ALTMIŞ&#160;</xsl:when>
        <xsl:when test="$digit=7">YETMIŞ&#160;</xsl:when>
        <xsl:when test="$digit=8">SEKSEN&#160;</xsl:when>
        <xsl:when test="$digit=9">DOKSAN&#160;</xsl:when>
        <xsl:otherwise />
    </xsl:choose>
</xsl:template>
<xsl:template name="hundredsDigit">
    <xsl:param name="digit" />
    <xsl:choose>
        <xsl:when test="$digit=1">YÜZ&#160;</xsl:when>
        <xsl:when test="$digit=2">İKI YÜZ&#160;</xsl:when>
        <xsl:when test="$digit=3">ÜÇ YÜZ&#160;</xsl:when>
        <xsl:when test="$digit=4">DÖRT YÜZ&#160;</xsl:when>
        <xsl:when test="$digit=5">BEŞ YÜZ&#160;</xsl:when>
        <xsl:when test="$digit=6">ALTI YÜZ&#160;</xsl:when>
        <xsl:when test="$digit=7">YEDI YÜZ&#160;</xsl:when>
        <xsl:when test="$digit=8">SEKIZ YÜZ&#160;</xsl:when>
        <xsl:when test="$digit=9">DOKUZ YÜZ&#160;</xsl:when>
        <xsl:otherwise />
    </xsl:choose>
</xsl:template>
</xsl:stylesheet>